"""
Django settings for an_app_creation_10234_1 project.
...
ROOT_URLCONF = 'an_app_creation_10234_1.urls'
...
WSGI_APPLICATION = 'an_app_creation_10234_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "An App creation 10234 Support <support@an-app-creation-10234-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "an_app_creation_10234_1 API",
    "DESCRIPTION": "API documentation for an_app_creation_10234_1 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "an_app_creation_10234_1.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "an_app_creation_10234_1.storage_backends.AzureStaticStorage"
